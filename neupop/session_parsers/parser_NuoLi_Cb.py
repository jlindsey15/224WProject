...
class ParserNuoLiCb(SessionParser):
    '''
    SessionParser for Nuo Li's Cerebellar perturbation data encoding,
    ...
    def parse_stim_site(self):
        ...
        self.s.stim_site[stim_site_input == 1] = 4 #Cb fastigial silencing
        self.s.stim_site[stim_site_input == 2] = 5 #Cb dentate silencing
        return
    ...
    def parse_stim_site_num2str_dict(self):
        ...
        self.s.stim_site_num2str_dict = {0:'no stim', 4:'FN', 5:'DN'}
        return
